...
// Fetch all scan logs
$sql = "SELECT card_id, emp_name, department, dustbin_id, scan_time FROM scan_logs ORDER BY scan_time DESC";
...
logEvent("User with email $email accessed all scan logs");
